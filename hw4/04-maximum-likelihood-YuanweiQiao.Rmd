...
- The N-R method doesn't converge if the initial value is far from the true value. 
- Improved the NR method by halving the steps if the likelihood is not improved. This did not improve the NR method's performance.
